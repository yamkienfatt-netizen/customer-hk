    ...
    return process.env.FETCH_WITH === constants.FETCH_WITH.GRAPHQL
      ? new GraphQLDictionaryService({
          ...
          */
          ...
          useSiteQuery: true,
          rootItemId: '{6772036A-C368-4D13-B0C6-A86F124A5B8A}',
          pageSize: process.env.GRAPHQL_DICTIONARY_SERVICE_PAGESIZE
            ? Number(process.env.GRAPHQL_DICTIONARY_SERVICE_PAGESIZE)
            : undefined,
        })
