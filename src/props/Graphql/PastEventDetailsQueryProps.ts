...
export type PastEventDetailsField = _ArticleCardGraphQL & _HappeningGraphQL & {
  id: string;
  name: string;
  url: {
    url: string;
...
export type PastEventDetailsQueryProps = GraphQlSearch<Array<PastEventDetailsField>> & {};
